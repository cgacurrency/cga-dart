...
main() {
  ...
  // Getting address (cga_, xpd) from this pubkey
  String address = NanoAccounts.createAccount(NanoAccountType.CGA, pubKey);
  // Validating address
  NanoAccounts.isValid(NanoAccountType.CGA, address);
